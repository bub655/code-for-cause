	...
	return (
		<>
			<div className="text-center p-4 md:p-8">
				...
				<Email />
				<div className="flex items-center md:flex-row flex-col w-full md:w-fit ml-auto mr-auto bg-[#D9D9D9] rounded-full p-2 md:p-4 text-black font-bold md:space-x-4 text-xl">
