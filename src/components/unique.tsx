    ...
    <div className="m-12 mt-20 flex flex-wrap justify-between">
      <div className="w-6/12 ml-6">
        <div className="text-4xl">
          <span className="font-black shadow-purple-400">Solve problems for  </span>
          <span className="font-black drop-shadow-[3px_4px_var(--tw-shadow-color)] shadow-[#896FBC]">real </span>
      ...
      <div className="p-2 w-5/12 ml-auto mr-auto text-center justify-contents-center font-bold text-lg">
        ...
        <div className="w-fit ml-auto mr-auto mt-2 bg-[#D9D9D9] rounded-[16px] p-8 tracking-wide text-black font-bold space-y-2 italic">
          <div className="line-through decoration-red-500 decoration-2">solve food wastage for the 1000th time</div>
